...
import { MyDocument } from './ExpertReportPDF';
import ErrorBoundary from './ErrorBoundary';

// This component wraps the ExpertReportPDF component with error handling
// and provides a cleaner API for the parent components
const ExpertReportPDFContainer = ({ data, chartImages }) => {
  ...
  return (
    ...
    >
      <MyDocument data={data} chartImages={chartImages || []} />
    </ErrorBoundary>
  );
};

export default ExpertReportPDFContainer;
